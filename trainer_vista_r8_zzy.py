...
#nohup python kgin_kv_train_vista_r8_zzy.py --config config_kgin_kv_vista_r8_zzy.yaml > log_vista_r8_0519.txt 2>&1 &
...
class TrainerAbstract:
    def __init__(self, config):
        ...
        if self.debug: config.general.exp_name = 'test_kgin_kv_vista_r8_zzy'
...
class TrainerKInterpolator(TrainerAbstract):
    ...
    def run_test(self):
        ...
        with torch.no_grad():
            ...
            # np.save('out_kgin_kv_vista_r8_zzy_0425_2.npy', out)
            np.save('out_kgin_kv_vista_r8_zzy_0519.npy', out)
