...
#nohup python kgin_kv_train_vista_r8_zzy.py --config config_kgin_kv_vista_r8_zzy.yaml > log_0216_test_3.txt 2>&1 &
...
class TrainerKInterpolator(TrainerAbstract):
    ...
    def run_test(self):
        ...
        with torch.no_grad():
            ...
            np.save('out_kgin_kv_vista_r8_zzy_0318.npy', out)
