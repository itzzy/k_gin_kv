...
forward-img_0F-2 type: <class 'torch.Tensor'>, shape: torch.Size([32, 64, 192, 192])
forward-img_0F-3 type: <class 'torch.Tensor'>, shape: torch.Size([32, 384, 64, 192])
  0%|                                                                                                                                                                    | 0/2 [00:09<?, ?it/s]
Traceback (most recent call last):
  ...
  File "/data0/zhiyong/code/github/itzzy_git/k-gin_kv/model/k_interpolator.py", line 355, in forward
...
RuntimeError: The size of tensor a (12288) must match the size of tensor b (384) at non-singleton dimension 1
'''
...
#        imgadd = torch.cat((mean_of_third_dim, tensor), dim=2)
    ...
    def forward(self, img, mask):
        ...
        for time in range(T-1):
            ...
            predt_list.append(predt.view(-1, self.ss, w, h_2))
